...
{
    private readonly string connectionstring = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Skola\Database\Lessons\Lektion-3\02_Database_with_SqlClient_Dapper\Data\local_db_dapper.mdf;Integrated Security=True;Connect Timeout=30";
